...
/**
 * Microsoft Clarity の Project ID。
 * 実際の tracking code は src/components/MicrosoftClarity.astro が出力し、
 * BaseLayout.astro の <head> から <GoogleAnalytics /> の直後に 1 回だけ読み込む。
 * 本番ビルド（import.meta.env.PROD）でのみ出力され、開発サーバーでは読み込まれない。
 */
export const CLARITY_PROJECT_ID = 'yik3uhrsxl';
